...
#Field Area defined here
    def createFieldArea(self):
        ...
        valueText1.setPlainText("0")
        valueText2 = QTextEdit()
        valueText2.setPlainText("0")
        valueText3 = QTextEdit()
        valueText3.setPlainText("1")
        valueText4 = QTextEdit()
        valueText4.setPlainText("0")
        valueText5 = QTextEdit()
        valueText5.setPlainText("2")
        
        maskLabel = QLabel("Mask")
        maskText1 = QTextEdit()
        maskText1.setPlainText("08")
        maskText2 = QTextEdit()
        maskText2.setPlainText("00")
        maskText3 = QTextEdit()
        maskText3.setPlainText("6861")
        maskText4 = QTextEdit()
        maskText4.setPlainText("809e")
        maskText5 = QTextEdit()
        maskText5.setPlainText("0f00")
...
#Packet Area defined here
    def createPacketArea(self):
        ...
        PacketAreaTabWidget.setSizePolicy(QSizePolicy.Preferred,
                QSizePolicy.Ignored)
